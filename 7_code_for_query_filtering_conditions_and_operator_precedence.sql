-- Write a query that returns those employees that don't make any commission and have a salary greater than 1100
...
--or greater than 1100 dollars in commission
SELECT * FROM EMP
WHERE JOB = 'SALESMAN'
